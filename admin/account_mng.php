                ...
                <td class='text-center'>
                    <div style='display:inline-flex;gap:5px;'>                    
                        <form method='POST' action='update_user.php'>           
                            ...
                            <button type='submit' class='btn' style='background:#EEEE00;'>Sửa</button>
                        </form>
                        <form method='POST' action='delete.php'>           
                            <input type='hidden' name ='id' value='$id'>  
                            <button type='submit' name='delete_user' class='btn' style='background:#FFA500;'>Xóa</button>
                        </form>
                    </div>
                </td>
    ...
    for ($page = 1; $page <= $number_of_page; $page++) {
        ...
        echo '
            <div style="display: flex;" class="' . $class . '">
                <a class="pagination-item__link" href="account_mng.php?page=' . $page . '">' . $page . '</a>
            </div>
        ';
    }
}
            ...
            <div class="row">
                <div class="management-category col-md-2">
                    <ul class="list_category">
                        ...
                        <li class="list_category--item">
                            <i class="fa-solid fa-cart-shopping"></i>
                            <a href="#!" class="active">Quản lý tài khoản</a>
                        </li>
                        <li class="list_category--item">
                            <i class="fa-solid fa-cart-shopping"></i>
