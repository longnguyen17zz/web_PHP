...
if(isset($_POST['txt_submit'])){
    ...
    if($result_query){
        echo "<script>window.location.href='http://localhost/ecommerce/layout_user/shop-login.php';</script>";
    }
}   
?>
...
<body>
    <main>
        ...
        <div class="container">
            <div class="shop">
                <div class="head-shop">
                    <div class="shop_sub-items" style='padding-top:100px;'>
                ...
                <div class="contact">
                    ...
                    <form class="contact_content" method="POST" action="">

                        <input type="text" readonly class="form-control contact_content-item " name="txt_name" id="txt_name"
                            placeholder="Họ Tên*" required value='<?php echo $_SESSION['name']?>'>

                        <input type="email" readonly class="form-control contact_content-item" name="txt_email" id="txt_mail"
                            placeholder="Email*" required value='<?php echo $_SESSION['email']?>'>


                        <input type="text" readonly class="form-control contact_content-item" name="txt_phone" id="txt_phone"
                            placeholder="Số Điện Thoại*" required value='<?php echo $_SESSION['phone']?> '> 
