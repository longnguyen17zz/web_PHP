...
// link: https://github.com/momo-wallet/payment/blob/master/php/atm/atm_momo.php
/**
 *NGUYEN VAN A
 *9704 0000 0000 0018
 *03/07
...
if (isset($_POST['payUrl'])) {
    ...
    $redirectUrl = "http://localhost/ecommerce/layout_user/homepage.php"; // trang chủ
    $ipnUrl = "http://localhost/ecommerce/layout_user/homepage.php"; // trang chủ
    $extraData = "";
