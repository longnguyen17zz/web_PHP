...
function display_list_number()
{
    ...
    if(!isset($_SESSION['email'])){
        if ($current_page > 1 && $number_of_page > 1){
            echo '<li class="pagination-item"><a class="pagination-item__link" href="index.php?page='.($current_page-1).'"><i class="pagination-item__icon"><i class="fa-solid fa-chevron-left"></i></i></a></li>';
        }
    }else {
        if ($current_page > 1 && $number_of_page > 1){
            echo '<li class="pagination-item"><a class="pagination-item__link" href="homepage.php?page='.($current_page-1).'"><i class="pagination-item__icon"><i class="fa-solid fa-chevron-left"></i></i></a></li>';
        }
    }
    ...
    if(!isset($_SESSION['email'])){
        if ($current_page < $number_of_page && $number_of_page > 1){
            echo '<li class="pagination-item"><a class="pagination-item__link" href="index.php?page='.($current_page+1).'"><i class="pagination-item__icon"><i class="fa-solid fa-chevron-right"></i></i></a></li>';
        }
    }else {
        if ($current_page < $number_of_page && $number_of_page > 1){
            echo '<li class="pagination-item"><a class="pagination-item__link" href="homepage.php?page='.($current_page+1).'"><i class="pagination-item__icon"><i class="fa-solid fa-chevron-right"></i></i></a></li>';
        }
    }
}
